...
export const RegistroExamen = ({
    ...
    useEffect(() => {
        console.log('detalle:', detalle, "Examen:", examen)
    }, [detalle])
        ...
        <>
            ...
            <div className='row2-Inputs'>
                ...
                <TextInputDinamic
                    ...
                    Placeholder={'Ej. Suero'}
                    OnChange={(e) => handleChangeCabecera(e)}
                    Value={examen.InformacionClinica || ""}
                />
            ...
            <div className='spaceVer15' />
            {
                examen._id != undefined ? camposHTML() : <></>
            }
    ...
    function camposHTML() {
        console.log("examen.Campos:")
        console.log(examen.Campos)
        return examen.Campos.map((det, i) => {
            return (
                <div key={det.id}>
